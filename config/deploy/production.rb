...
server "ec2-13-126-28-255.ap-south-1.compute.amazonaws.com", user: "ubuntu", roles: %w{app db web}, my_property: :my_value
...
# --------------
 set :ssh_options, {
   keys: %w(/home/yuva/Downloads/chat-staging.pem),
   forward_agent: false,
   user: 'ubuntu'
 }
#
